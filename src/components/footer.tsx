...
export function Footer() {
  return (
    <div className="h-[35rem] mt-36 w-full  bg-slate-950 relative flex flex-col items-center justify-center antialiased">
          ...
          <div className="lg:flex lg:items-start lg:gap-8">
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end justify-end">
                <div className="text-8xl tracking-widest text-primary">
                  Xmart
                </div>
              </div>
